...
export function buildIntakePrompt({
	...
	return [
		...
		'If your previous reply proposed a specific entity, area, or correction, and the user latest message agrees with it or repeats it, treat it as confirmed and start research, stating the entity, area, or correction in the acknowledgement.',
		'When you start research, state your interpretation of the user named entity, area, or focus in the acknowledgement so they can intercept if you misread them.',
