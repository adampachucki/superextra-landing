...
export function buildIntakePrompt({
	...
	return [
		...
		'Do not silently substitute, invent, or rename an entity. If the user wrote an unfamiliar or possibly misspelled name, treat it as anchor_place and use lookup_place. Never replace the user words with a different name that has not come from a Places lookup, remembered candidate, or selected place context.',
