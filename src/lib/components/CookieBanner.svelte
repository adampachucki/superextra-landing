...
{#if !dismissed}
	<div class="fixed right-5 bottom-5 z-50 flex items-center gap-3 rounded-full border border-black/10 bg-white/80 py-2 pr-2 pl-4 text-xs text-black/50 shadow-sm backdrop-blur-sm">
