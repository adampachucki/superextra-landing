...
<svg
	viewBox="0 0 200 200"
	fill="none"
	class="relative z-10 w-3/5 text-black dark:text-white"
	class:hovered
>
	{#if index === 0}
	...
	{:else if index === 3}
		...
		<g class="gantt-row-1"
			><rect
				...
				stroke="currentColor"
				stroke-width="1"
			/><circle cx="25" cy="37" r="1.5" fill="currentColor" /></g
		>
		<g class="gantt-row-2"
			><rect
				x="55"
				...
				stroke="currentColor"
				stroke-width="1"
			/><circle cx="55" cy="60" r="1.5" fill="currentColor" /></g
		>
		<g class="gantt-row-3"
			><rect
				class="ants"
				...
				stroke-width="0.8"
				stroke-dasharray="4,3"
			/><circle cx="80" cy="83" r="1.5" fill="currentColor" /></g
		>
		<g class="gantt-row-4"
			><rect
				x="25"
				...
				stroke="currentColor"
				stroke-width="1"
			/><circle cx="25" cy="106" r="1.5" fill="currentColor" /><rect
				x="100"
				y="101"
				width="75"
				height="10"
				...
				stroke="currentColor"
				stroke-width="0.8"
			/><circle cx="100" cy="106" r="1.5" fill="currentColor" /></g
		>
		<g class="gantt-row-5"
			><rect
				class="ants-rev"
				...
				stroke-width="0.7"
				stroke-dasharray="4,3"
			/><circle cx="40" cy="129" r="1.5" fill="currentColor" /></g
		>
		<g class="gantt-row-6"
			><rect
				x="25"
				...
				stroke="currentColor"
				stroke-width="1"
			/><circle cx="25" cy="152" r="1.5" fill="currentColor" /><rect
				x="110"
				y="147"
				width="65"
				height="10"
				...
				stroke="currentColor"
				stroke-width="0.8"
			/><circle cx="110" cy="152" r="1.5" fill="currentColor" /></g
		>
	{:else if index === 4}
		...
		<g class="wave-solid-group">
			<path
				d="M 20,110 C 55,55 75,55 110,110 S 165,165 190,110"
				stroke="currentColor"
				stroke-width="1"
			/>
		...
		<g class="wave-dash-group">
			<path
				class="ants"
				d="M 20,125 C 60,75 90,75 120,110 S 170,145 190,100"
				stroke="currentColor"
				stroke-width="0.7"
				stroke-dasharray="4,3"
			/>
	...
	{:else if index === 6}
		...
		<path
			class="sweep-arc"
			d="M 100,20 A 80,80 0 0,1 174,68"
			stroke="currentColor"
			stroke-width="2.5"
		/>
		<path
			class="sweep-arc"
			d="M 100,40 A 60,60 0 0,1 152,72"
			stroke="currentColor"
			stroke-width="1.8"
		/>
		<circle cx="100" cy="100" r="2" fill="currentColor" />
	...
	{:else if index === 7}
		...
		<g class="enrich-layer-1">
			<path
				class="ants"
				d="M 100,28 L 170,58 L 100,88 L 30,58 Z"
				stroke="currentColor"
				stroke-width="0.5"
				stroke-dasharray="3,3"
			/>
...
<style>
	...
	.hovered .sweep-arc:nth-of-type(1) {
		transform: rotate(15deg);
	}
	.hovered .sweep-arc:nth-of-type(2) {
	...
	.hovered .enrich-layer-1 {
		transform: translateY(8px);
	}
	.hovered .enrich-layer-2 {
		transform: translateY(4px);
	}
	.hovered .enrich-layer-3 {
		transform: translateY(-4px);
	}
	.hovered .enrich-layer-4 {
		transform: translateY(-8px);
	}
</style>
