...
<style>
	...
	.hovered .orbit-1-group { transform: rotate(-42deg) scaleX(0.92) scaleY(1.1); }
	...
	.hovered .venn-a { transform: translate(-4px, -3px) scale(1.06); }
	...
	.hovered .wave-solid-group { transform: scaleY(1.12) scaleX(0.98); }
	.wave-dash-group {
		transform-origin: 105px 110px;
		transform: scaleY(1) scaleX(1);
	...
	.hovered .gantt-row-1 { transform: scaleX(1.08); }
	.hovered .gantt-row-4 { transform: scaleX(0.92); }

	/* === 5: Sales & Leads — nodes scale outward from hub === */
	.node-a, .node-b, .node-c, .node-d,
	.node-e, .node-f, .node-g, .node-h {
		transition: transform 0.5s ease;
		transform-origin: 100px 100px;
	}
	.hovered .node-a { transform: scale(1.1); }
	.hovered .node-b { transform: scale(1.08); }
	.hovered .node-c { transform: scale(1.08); }
	.hovered .node-d { transform: scale(1.07); }
	.hovered .node-e { transform: scale(1.09); }
	.hovered .node-f { transform: scale(1.11); }
	.hovered .node-g { transform: scale(1.05); }
	.hovered .node-h { transform: scale(1.08); }
	.link-bc, .link-ef {
		transition: transform 0.5s ease;
		transform-origin: 100px 100px;
	}
	.hovered .link-bc { transform: scale(1.08); }
	.hovered .link-ef { transform: scale(1.10); }

	/* === 6: Due Diligence — sweep arcs rotate === */
	.sweep-arc {
		transition: transform 0.6s ease;
		transform-origin: 100px 100px;
	}
	.hovered .sweep-arc:nth-of-type(1) { transform: rotate(15deg); }
	.hovered .sweep-arc:nth-of-type(2) { transform: rotate(10deg); }

	/* === 7: Enrichment — layers compress together === */
	.enrich-layer-1, .enrich-layer-2,
	.enrich-layer-3, .enrich-layer-4 {
		transition: transform 0.5s ease;
	}
	.hovered .enrich-layer-1 { transform: translateY(8px); }
	.hovered .enrich-layer-2 { transform: translateY(4px); }
	.hovered .enrich-layer-3 { transform: translateY(-4px); }
	.hovered .enrich-layer-4 { transform: translateY(-8px); }
</style>
