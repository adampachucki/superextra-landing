<script lang="ts">
	const heatData: number[][] = [
		[0.12, 0.2, 0.45, 0.28, 0.52, 0.18, 0.1],
		[0.15, 0.32, 0.65, 0.75, 0.6, 0.35, 0.12],
		[0.18, 0.42, 0.85, 0.92, 0.8, 0.45, 0.18],
		[0.12, 0.28, 0.55, 0.68, 0.52, 0.3, 0.12],
		[0.08, 0.18, 0.35, 0.4, 0.28, 0.15, 0.08],
		[0.05, 0.1, 0.2, 0.25, 0.15, 0.08, 0.05]
	];
