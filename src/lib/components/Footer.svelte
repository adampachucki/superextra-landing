...
<footer class="{borderless ? '' : 'border-t border-cream-200'} py-12 pb-20 md:pb-12">
					...
					<div class="flex flex-col items-center gap-4 md:flex-row md:gap-6">
						<div class="hidden items-center gap-2 md:flex">
							...
							<img
								...
								class="h-3.5 translate-y-px opacity-40 grayscale dark:invert"
							/>
						</div>
						...
						<!-- Icon buttons: LinkedIn, theme, language -->
