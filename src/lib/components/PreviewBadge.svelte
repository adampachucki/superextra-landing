...
<div class="fixed bottom-5 left-5 z-50">
	<button
		...
		class="flex items-center gap-1.5 rounded-full border border-black/10 bg-white/80 px-3 py-1.5 text-xs font-medium text-black/60 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.06)] backdrop-blur-sm transition-colors hover:text-black/80"
	>
