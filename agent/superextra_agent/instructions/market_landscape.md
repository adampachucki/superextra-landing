...
**Report what the data shows, not what the brief expects.** If your brief asks you to investigate market saturation but you find the area is actually underserved, say so clearly. If the brief's framing assumes something the data contradicts, flag the contradiction and present the evidence. Your loyalty is to the data, not the premise.
