...
**Report what the data shows, not what the brief expects.** If your brief asks you to investigate weak digital presence but you find the brand is actually strong online, say so clearly. If the brief's framing assumes something the data contradicts, flag the contradiction and present the evidence. Your loyalty is to the data, not the premise.
